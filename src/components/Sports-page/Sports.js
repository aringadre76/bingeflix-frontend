...
const Sports = () => {
    ...
    return (
        <div className = "grid grid-rows-1 gap-1 bg-gray-600">
            <div className="relative grid grid-rows-2 gap-1 bg-gray-600">
            <Header/>
                <div className="relative row-span-1 bg-cover bg-center"style={{ height: '800px'}}> {/* Position the overlay here */}
                ...
                {/* Recommendations */}
                <div className = "grid grid-rows-2 gap-1 bg-gray-600">
                    <div className = "relative row-span-2" style = {{
                        backgroundImage: "url('/netfliximage.jpg')",
                        backgroundBlendMode: "multiply",
                        backgroundColor: "rgba(247, 119, 185, 0.8)",
                        width: '100%'
                    }}> 
                        <div className="relative text-black text-3xl font-bold" style={{ top: '30%', left: '10%', width: '40%', height: '20%'}}>
                        Sports
                        </div>
                        <div className="relative text-black text-3xl font-bold hide-on-iphone" style={{ top: '25%', left: '15%',  width: '25%'}}>
                        Your sports
                        </div>
                    </div>
                </div>
